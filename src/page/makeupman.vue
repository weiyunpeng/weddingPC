...
<div class="container">
    ...
    <div class="fl">
        ...
        <div class="fl about_package" v-if="makeupmanPackages && makeupmanPackages.length>0">
            <p class="p_tit clearfix">
                相关套餐
            </p>
            <ul>
                <li v-for="(item,s) in makeupmanPackages" :key="s">
                    <router-link :to="{ name: 'packageDetails',params: {busId:makeupmanBusinfo.store_id, mealId:item.id}}" target="_blank">

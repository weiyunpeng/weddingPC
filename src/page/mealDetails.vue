    ...
    <div class="container" id="mealDetails">
        ...
        <div class="remaining clearfix">
            <div class="fl details">
                <div class="subnav">
                    <ul>
                        <li v-for="(item,i) in ['套餐详情','图文详情']" :key="i" class="subnav_li"><a v-bind:class="{cur: selected == i}" :href="'#subnav-'+i" @click="changeTab(i)">{{item}}</a></li>
                    </ul>
                </div>
                <div class="deposit item" name="subnav-0" id="subnav-0">
                    <div class="tit">
                        定金
                        <i class="mark"></i>
                    </div>
                ...
                <div class="graphic item" name="subnav-1" id="subnav-1">
                    <div class="tit">
                        图文详情
                        <i class="mark"></i>
                    </div>

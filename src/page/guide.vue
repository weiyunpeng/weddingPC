                ...
                <div class="new-evaluation fr">
                    ...
                    <ul>
                        <li v-for="(item,index) in comments" :key="index">
                            ...
                            <div class="li-ct">
                                <span class="sj fl">拍摄商家：{{item.storeName}}</span>
...
.hot-raiders {
  ...
  .new-evaluation {
    ...
    .eval-tit {
      font-size: 24px;
      color: #1a1a1a;
      background: url(../../static/images/tit-bg1.png) left bottom no-repeat;
      padding-bottom: 6px;
      text-align: left;
      margin-bottom:20px;
      span {
    ...
    ul li {
      ...
      .li-ct {
        ...
        .sj {
          display: inline-block;
          color: #fc70ae;
          background: url(../../static/images/sj-icon.png) left center no-repeat;
          padding-left: 20px;
          width:230px;
